...
public class MainMenuScene extends SceneGame {
    ...
    @Override
    public void drawing() {
        pGraphicsGame.clearScene(Color.GRAY);
        pGraphicsGame.drawText(pCoreGame.getString(R.string.txt_mainMenu_nameGame)
                , 100, 100,Color.rgb(255, 182, 193), 60,ResourceGame.mainMenuFont );
        pGraphicsGame.drawText(pCoreGame.getString(R.string.txt_mainMenu_newGame), 20, 300,Color.rgb(255, 182, 193), 40,ResourceGame.mainMenuFont );
        pGraphicsGame.drawText(pCoreGame.getString(R.string.txt_mainMenu_settings), 20, 350,Color.rgb(255, 182, 193), 40,ResourceGame.mainMenuFont );
        pGraphicsGame.drawText(pCoreGame.getString(R.string.txt_mainMenu_results), 20, 400,Color.rgb(255, 182, 193), 40,ResourceGame.mainMenuFont );
        pGraphicsGame.drawText(pCoreGame.getString(R.string.txt_mainMenu_exitGame), 20, 450,Color.rgb(255, 182, 193), 40,ResourceGame.mainMenuFont );
    }
    //endregion
